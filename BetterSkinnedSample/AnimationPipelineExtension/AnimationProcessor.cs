...
namespace BetterSkinnedSample.AnimationPipelineExtension
{
    ...
    public class AnimationProcessor : ModelProcessor
    {
        ...
        /// </summary>
        private readonly ModelExtra modelExtra = new ModelExtra();

        /// <summary>
        ///     A lookup dictionary that remembers when we changes a material to skinned material.
        /// </summary>
        private readonly Dictionary<MaterialContent, SkinnedMaterialContent> toSkinnedMaterial =
        ...
        private void FlattenTransforms(NodeContent node, BoneContent skeleton)
        {
            foreach (var child in node.Children)
            {
                ...
                if (IsSkinned(child)) FlattenAllTransforms(child);
            }
        }
        ...
        private bool UselessAnimationTest(int boneId)
        {
            ...
            foreach (var b in modelExtra.Skeleton)
                if (boneId == b)
                    return false;
